    ...
    <SafeAreaView style={[styles.safe, { backgroundColor: colors.background }]} edges={['top', 'bottom']}>
      <KeyboardAvoidingView style={styles.safe} behavior={Platform.OS === 'ios' ? 'padding' : undefined}>
        <ScrollView keyboardShouldPersistTaps="handled" contentContainerStyle={styles.content}>
          ...
          <AppText style={styles.title}>Choose a new password</AppText>
...
const styles = StyleSheet.create({
  ...
  title: { marginTop: 44, fontSize: 38, lineHeight: 43, letterSpacing: -1.5 }, copy: { marginTop: 12, marginBottom: 30, fontSize: 15, lineHeight: 24 },
  card: { gap: 22 }, label: { fontSize: 12, marginBottom: 9, marginLeft: 2 },
  inputShell: { minHeight: 56, borderRadius: radius.panel, borderWidth: StyleSheet.hairlineWidth, paddingLeft: 13, flexDirection: 'row', alignItems: 'center', gap: 9 },
  input: { flex: 1, height: 55, fontFamily: fonts.regular, fontSize: 15 }, eyeButton: { width: 46, height: 46, alignItems: 'center', justifyContent: 'center' },
  requirements: { flexDirection: 'row', alignItems: 'center', flexWrap: 'wrap', gap: 6 }, requirement: { fontSize: 11, lineHeight: 16, marginRight: 8 },
