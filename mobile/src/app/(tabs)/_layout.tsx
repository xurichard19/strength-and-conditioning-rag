...
export default function TabsLayout() {
  ...
  return (
    <TopTabs initialRouteName="today" tabBarPosition="bottom" keyboardDismissMode="on-drag" screenOptions={{
      ...
      tabBarIndicatorStyle: { backgroundColor: colors.tint, height: 2, top: 0 },
      tabBarLabelStyle: styles.label,
      tabBarItemStyle: styles.item,
      tabBarStyle: [styles.bar, { backgroundColor: colors.tab, borderTopColor: colors.separator,
...
const styles = StyleSheet.create({
  bar: { paddingTop: 7, borderTopWidth: StyleSheet.hairlineWidth, elevation: 0, shadowOpacity: 0 },
  item: { paddingVertical: 3, paddingHorizontal: 0 },
  label: { fontFamily: fonts.regular, fontSize: 10, lineHeight: 14, letterSpacing: 0.1, textTransform: 'none' },
  hidden: { display: 'none' },
});
